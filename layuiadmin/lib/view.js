        ...
        i.loading = function (e) {
            ...
            i.req = function (e) {
                ...
                return e.data = e.data || {},
                    e.headers = e.headers || {},
                    a.tokenName && (e.headers[a.tokenName] = a.tokenName in e.headers ? e.headers[a.tokenName] : layui.data(r.tableName)[a.tokenName] || ""),
                    delete e.success,
                    delete e.error,
                    t.ajax(t.extend({
                        type: "get",
            ...
            i.reqSetup = function () {
                ...
                if (request.tokenName) {
                    layui.$.ajaxSetup({
                        headers: {
                            [request.tokenName]: layui.data(r.tableName)[request.tokenName] || ''
                        }
                    });
                }
            },
